...
let orderSearchTerm = "";
let reportPeriod = "today"; // রিকোয়ারমেন্ট ৪: ডিফল্ট 'Today' করা হলো
let currentReportTab = "profit-report";
let dashPeriod = "today"; // রিকোয়ারমেন্ট ৪: ড্যাশবোর্ডের ডিফল্ট 'Today' করা হলো
...
/* =======================================================================
   REQUISITION 1: ORDER & WHOLESALE PREVIEW MODAL
======================================================================= */
...
/* =======================================================================
   FIFO INVENTORY & INSTANT STOCK DEDUCTIONS (REQS 2 & 3)
======================================================================= */
...
// রিকোয়ারমেন্ট ২ ও ৩: অর্ডার এন্ট্রি করার সাথে সাথেই স্টক থেকে মাইনাস হবে
...
/* =======================================================================
   COURIER, FRAUD CHECKER & GENERAL UTILITIES (ALL PRESERVED)
======================================================================= */
...
async function runManualFraudCheck() {
  ...
  toast(data.isSuccess ? `ফলাফল পাওয়া গেছে: মোট অর্ডার ${data.total}` : "কোনো ডাটা পাওয়া যায়নি");
}
...
function attemptLogin() {
  ...
  } else { alert("ভুল ইউজারনেম অথবা পাসওয়ার্ড!"); }
}
...
function handleGlobalSearch(query) {
  ...
  resBox.innerHTML = `<div style="padding:10px;text-align:center;">সার্চ রেজルト...</div>`;
...
/* =======================================================================
   WHOLESALE (INSTANT STOCK DEDUCTION & PREVIEW)
======================================================================= */
...
// রিকোয়ারমেন্ট ৩: পাইকারি অর্ডারে এন্ট্রি হওয়ার সাথেই স্টক থেকে মাইনাস হবে
document.getElementById("btn-save-wholesale").addEventListener("click", () => {
  ...
  if (editingWholesaleId) {
    ...
    if (idx !== -1) {
      ...
      toast("পাইকারি অর্ডার আপডেট হয়েছে");
    }
  } else {
    ...
    toast("পাইকারি অর্ডার এন্ট্রি হওয়ার সাথেই স্টক থেকে মাইনাস হয়েছে");
  }
  ...
  tbody.innerHTML = list.length ? list.map(w => `
    <tr>
      ...
      <td style="text-align:center">
        ...
        <button class="btn ghost sm" onclick="openWholesaleModal(${w.id})">Edit</button>
...
/* =======================================================================
   RETAIL ORDERS (INSTANT STOCK REDUCTION & PREVIEW BUTTON)
======================================================================= */
...
// রিকোয়ারমেন্ট ২: অর্ডার এন্ট্রি করার সাথে সাথেই স্টক থেকে মাইনাস হবে
document.getElementById("btn-save-order").addEventListener("click", () => {
  ...
  if (editingOrderId) {
    ...
    applyAutomaticDeductions(newOrd); // অর্ডার সেভ হওয়ার সাথেই স্টক মাইনাস
